    ...
    <aside className="teacher-sidebar">
      ...
      <nav className="sidebar-nav">
        <ul>
          ...
          {/* ✅ Add profile route in sidebar (optional) */}
          <li className={`nav-item ${activeTab === "profile" ? "active" : ""}`}>
            <Link to="/dashboard/teacher/profile" className="flex items-center space-x-3 w-full">
              <UserCircle className="nav-icon" /> <span>Profile</span>
            </Link>
          </li>
        </ul>
      </nav>
