...
import StudentGroups from "./StudentGroups"; // ✅ added
...
const StudentDashboard = () => {
  ...
  // ---------------------- NOTIFICATIONS ----------------------
  const notifications = [
    { id: 1, text: "Your question on exam prep got 2 new replies", time: "2h ago" },
    { id: 2, text: "Don't forget to log your daily mood today", time: "5h ago" },
    { id: 3, text: "New study group formed for Calculus", time: "1d ago" },
  ];
    ...
    <div className="student-dashboard-wrapper">
      ...
      <div className="student-dashboard-main">
        ...
        <div className="student-dashboard-content">
          ...
          {activeSection === "groups" && <StudentGroups />} {/* ✅ handled here */}
        </div>
      </div>
    </div>
  );
