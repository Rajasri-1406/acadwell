...
import ChatRoom from "../../chat/ChatRoom"; // ✅ common chat component
    ...
    <header className="teacher-topbar">
      ...
      <div className="topbar-right">
        ...
        <button className="profile-btn">
          ...
          <span className="profile-text">Alex Teacher</span>
        </button>
      </div>
    </header>
  );
  ...
  const WelcomeCard = () => (
    <div className="dashboard-card welcome-card">
      <div className="welcome-content">
        <h2 className="welcome-title">Welcome Back, Alex Teacher 👋</h2>
      ...
      <div className="teacher-dashboard-main">
        ...
        <div className="teacher-dashboard-content">
          <Routes>
            ...
            <Route path="chat" element={<ChatRoom userType="Teacher" />} /> {/* ✅ Chat */}
